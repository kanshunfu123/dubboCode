package com.xiaowei.sys.platform.core.common.dal.config;
...
@MapperScan(basePackages = {"com.xiaowei.sys.platform.core.common.dal"}, sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        String path = "classpath*:com/xiaowei/sys/platform/core/common/dal/mapper/xml/*.xml";
