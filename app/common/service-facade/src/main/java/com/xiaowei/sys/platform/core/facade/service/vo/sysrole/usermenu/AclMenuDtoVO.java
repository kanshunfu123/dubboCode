 ...
 */
public class AclMenuDtoVO implements Serializable {// 是否要默认选中
    private boolean checked = false;

    // 是否有权限操作
    private boolean hasAcl = false;

    private List<AclMenuDtoVO> buttons;//按钮
    ...
    public List<AclMenuDtoVO> getButtons() {
        return buttons;
    }

    public void setButtons(List<AclMenuDtoVO> buttons) {
